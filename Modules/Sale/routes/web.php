...
Route::middleware('auth')->prefix('sales')->name('sales.')->group(function () {
    ...
    Route::post('/{sale}/sync-courier', [SaleController::class, 'syncCourier'])->name('sync-courier');
    Route::post('/{sale}/manual-courier-update', [SaleController::class, 'manualCourierUpdate'])->name('manual-courier-update');
