...
@section('title', __('Edit Asset Category'))
    ...
    <div class="bp-card-body">
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <input type="number" class="bp-form-control" name="useful_life_years" value="{{ old('useful_life_years', $category->useful_life_years) }}" min="1" max="100">
        </div>

        <div class="col-md-6">
          <label class="bp-form-label">Depreciation Rate (%)</label>
          <input type="number" step="0.01" class="bp-form-control" name="depreciation_rate" value="{{ old('depreciation_rate', num_input($category->depreciation_rate)) }}" min="0" max="100">
        </div>
      </div>
    </div>
