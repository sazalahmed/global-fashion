{{-- Shared fields for the give-advance & record-recovery modals.
...
<div class="row g-3">
    ...
    <div class="col-md-6">
        ...
        <input type="date" class="bp-form-control" name="advance_date" value="{{ date('Y-m-d') }}" required>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="bp-form-control" name="reference" placeholder="e.g. bKash TrxID / voucher">
    </div>
    <div class="col-12">
