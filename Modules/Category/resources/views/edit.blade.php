            ...
            <div class="bp-card-body">
                <div class="row g-3">
                    <div class="col-12 category_img">
                        <x-core::image-upload name="image" id="category-image" label="Image" removeName="remove_image" :current="$category->image ? upload_url($category->image) : null" />
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="bp-form-control @error('name') is-invalid @enderror" name="name"
                            id="category-name" value="{{ old('name', $category->name) }}" required
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="bp-form-control @error('slug') is-invalid @enderror" name="slug"
                            id="category-slug" value="{{ old('slug', $category->slug) }}"
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-check form-switch d-inline-flex align-items-center gap-2 me-4">
                            <input class="form-check-input" type="checkbox" id="showInMenu" name="show_in_menu"
                                value="1" {{ old('show_in_menu', $category->show_in_menu) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch d-inline-flex align-items-center gap-2">
                            <input class="form-check-input" type="checkbox" id="showInTop" name="show_in_top" value="1"
                                {{ old('show_in_top', $category->show_in_top) ? 'checked' : '' }}>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <input type="text" class="bp-form-control @error('meta_title') is-invalid @enderror"
                            name="meta_title" data-seo-title value="{{ old('meta_title', $category->meta_title) }}"
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="bp-form-control @error('meta_description') is-invalid @enderror" name="meta_description"
                            data-seo-desc rows="2" placeholder="SEO meta description for search engines...">{{ old('meta_description', $category->meta_description) }}</textarea>
