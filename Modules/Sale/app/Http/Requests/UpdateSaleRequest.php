...
class UpdateSaleRequest extends FormRequest
{
    ...
    /**
     * Drop empty advance/payment rows before validation so an untouched (or
     * blank) advance row doesn't trip the required_with rules.
     */
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'action'               => ['nullable', 'in:draft,create,update'],
        ];
    }
